...
```
compile 'com.amosyuen.ffmpegvideorecorder:ffmpeg-video-recorder:1.0.1'
```
...
```
<dependency org='com.amosyuen.ffmpegvideorecorder' name='ffmpeg-video-recorder' rev='1.0.1'>
